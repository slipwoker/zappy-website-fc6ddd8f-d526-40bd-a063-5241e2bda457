    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Tsababa BAY WEAR משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'fc6ddd8f-d526-40bd-a063-5241e2bda457',
                    name: data.name || '',
                    email: data.email || '',
